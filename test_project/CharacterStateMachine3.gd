extends Node
class_name CharacterStateMachine3 

@export var character : CharacterBody2D 
@export var current_state : State3
@export var animation_tree : AnimationTree
var States : Array[State3]
...
func switch_states(new_state : State3):
	if(current_state  != null):
...
func on_state_interrupt_state(new_state : State3 ):
