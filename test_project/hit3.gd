...
class_name HitState3


@export var Damageable              : damageable3
@export var character_State_Machine : CharacterStateMachine3
@export var _dead_state             : State3
@export var return_state            : State3   # set this to the walk/chase state
...
var _previous_state : State3 = null
